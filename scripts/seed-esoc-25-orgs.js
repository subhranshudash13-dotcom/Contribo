...
const ALL_25_ESOC_ORGS_AND_PROJECTS = [
  {
    org: {
      ...
      logoUrl: 'https://cdn.simpleicons.org/nasa',
  ...
  {
    org: {
      name: 'ESA ESOC Mission Operations',
      slug: 'esa-esoc-ops',
      description: 'ESA European Space Operations Centre (ESOC) in Darmstadt manages satellite flight control, ground station communication networks, and the EGS-CC spacecraft telemetry system.',
      websiteUrl: 'https://www.esa.int/About_Us/ESOC',
      logoUrl: 'https://cdn.simpleicons.org/gnuradio',
      category: 'Mission Operations & Flight Control',
      technologies: ['c++', 'java', 'python', 'linux', 'telemetry'],
      topics: ['space-operations', 'flight-control', 'telemetry', 'satellite-tracking'],
      years: [2020, 2021, 2022, 2023, 2024, 2025, 2026],
      is2026: true,
      projectCount: 1,
    },
    projects: [
      {
        title: 'EGS-CC European Ground System Telemetry Packet Stream Decommutator',
        description: 'Implement high-throughput CCSDS telemetry packet parsing with zero-copy ring buffers for real-time deep-space mission telemetry displays.',
        difficulty: 'Advanced',
        techStack: ['c++', 'python', 'telemetry', 'ccsds'],
        githubUrl: 'https://github.com/esa/egscc-packet-parser',
        stars: 420,
        mentors: ['Mario Merri', 'Paul Ferri'],
        topics: ['telemetry', 'ccsds', 'flight-control'],
        year: 2026,
      }
    ]
  },
  {
    org: {
      name: 'ESA Copernicus Earth Observation (SNAP)',
      slug: 'esa-copernicus',
      description: 'The Copernicus Earth Observation programme operates the Sentinel satellite constellation, developing the open-source Sentinel Application Platform (SNAP).',
      websiteUrl: 'https://step.esa.int/main/toolboxes/snap',
      logoUrl: 'https://cdn.simpleicons.org/qgis',
      category: 'Remote Sensing & Geospatial Earth Observation',
      technologies: ['java', 'python', 'gdal', 'c++', 'geospatial'],
      topics: ['earth-observation', 'remote-sensing', 'sentinel', 'gis'],
      years: [2020, 2021, 2022, 2023, 2024, 2025, 2026],
      is2026: true,
      projectCount: 1,
    },
    projects: [
      {
        title: 'SNAP Sentinel-2 Multispectral Atmospheric Correction GPU Pipeline',
        description: 'Accelerate Sen2Cor surface reflectance algorithms using OpenCL/CUDA kernels for real-time cloud and shadow masking on Sentinel-2 imagery.',
        difficulty: 'Advanced',
        techStack: ['python', 'java', 'gdal', 'opencl'],
        githubUrl: 'https://github.com/senbox-org/snap-engine',
        stars: 950,
        mentors: ['Dr. Carsten Brockmann', 'Norman Fomferra'],
        topics: ['remote-sensing', 'sentinel', 'gpu', 'geospatial'],
        year: 2026,
      }
    ]
  },
  ...
  {
    org: {
      name: 'EUMETSAT Weather & Climate Earth Observation',
      slug: 'eumetsat',
      description: 'EUMETSAT operates European meteorological satellites, developing Satpy, pyresample, and open climate telemetry processing engines.',
      websiteUrl: 'https://www.eumetsat.int',
      logoUrl: 'https://cdn.simpleicons.org/weatherunderground',
      category: 'Meteorology & Climate Satellites',
      technologies: ['python', 'numpy', 'xarray', 'dask', 'gdal'],
      topics: ['climate', 'weather-satellites', 'earth-observation', 'satpy'],
      years: [2021, 2022, 2023, 2024, 2025, 2026],
      is2026: true,
      projectCount: 1,
    },
    projects: [
      {
        title: 'Satpy Geostationary Weather Satellite False-Color RGB Compositor',
        description: 'Implement distributed Dask arrays for generating true-color Rayleigh-corrected aerosol storm imagery in real time.',
        difficulty: 'Intermediate',
        techStack: ['python', 'numpy', 'dask', 'xarray'],
        githubUrl: 'https://github.com/pytroll/satpy',
        stars: 830,
        mentors: ['Martin Raspaud', 'David Hoese'],
        topics: ['satpy', 'weather', 'geospatial', 'satellites'],
        year: 2026,
      }
    ]
  },
  {
    org: {
      ...
      slug: 'astron-radio',
      description: 'ASTRON operates the LOFAR telescope and coordinates international radio astronomy arrays, developing open signal processing and RFI mitigation engines.',
      websiteUrl: 'https://www.astron.nl',
      logoUrl: 'https://cdn.simpleicons.org/gnuradio',
      category: 'Radio Astronomy & Signal Processing',
      technologies: ['c++', 'python', 'cuda', 'opencl', 'radio-astronomy'],
      topics: ['radio-telescope', 'lofar', 'ska', 'signal-processing'],
      years: [2020, 2021, 2022, 2023, 2024, 2025, 2026],
      is2026: true,
      projectCount: 1,
    },
    projects: [
      {
        title: 'AOFlagger Automated Radio Frequency Interference (RFI) Excision',
        description: 'Optimize multi-scale Gabor filter bank algorithms on GPUs for detecting and excising 5G / satellite communication interference from deep sky data.',
        difficulty: 'Advanced',
        techStack: ['c++', 'cuda', 'opencl', 'signal-processing'],
        githubUrl: 'https://gitlab.com/aroffringa/aoflagger',
        stars: 390,
        mentors: ['Dr. André Offringa'],
        topics: ['signal-processing', 'radio-astronomy', 'gpu'],
        year: 2026,
      }
    ]
  },
  {
    org: {
      name: 'Fraunhofer Society Open Space & IoT',
      slug: 'fraunhofer-space',
      description: 'Fraunhofer is Europe largest application-oriented research organization, authoring the FROST-Server for OGC SensorThings spatial telemetry.',
      websiteUrl: 'https://www.fraunhofer.de/en.html',
      logoUrl: 'https://cdn.simpleicons.org/eclipseide',
      category: 'Applied Sensor Networks & Space IoT',
      technologies: ['java', 'postgresql', 'postgis', 'docker', 'mqtt'],
      topics: ['iot', 'sensor-networks', 'geospatial', 'ogc'],
      years: [2021, 2022, 2023, 2024, 2025, 2026],
      is2026: true,
      projectCount: 1,
    },
    projects: [
      {
        title: 'FROST-Server High-Velocity Satellite Constellation SensorThings Streamer',
        description: 'Build real-time MQTT 5.0 push notifications and GeoJSON trajectory streams for tracking orbital environmental sensors.',
        difficulty: 'Intermediate',
        techStack: ['java', 'postgresql', 'mqtt', 'postgis'],
        githubUrl: 'https://github.com/FraunhoferIOSB/FROST-Server',
        stars: 560,
        mentors: ['Hylke van der Schaaf'],
        topics: ['iot', 'geospatial', 'satellites', 'mqtt'],
        year: 2026,
      }
    ]
  },
  {
    org: {
      ...
      slug: 'mpia-astronomy',
      description: 'Max Planck Institute for Astronomy conducts leading observational and theoretical astrophysical research on planet formation and stellar physics.',
      websiteUrl: 'https://www.mpia.de/en',
      logoUrl: 'https://cdn.simpleicons.org/astropy',
      category: 'Theoretical Astrophysics & Exoplanets',
      technologies: ['python', 'c++', 'fortran', 'openmp'],
      topics: ['astrophysics', 'spectroscopy', 'exoplanets', 'radiative-transfer'],
      years: [2020, 2021, 2022, 2023, 2024, 2025, 2026],
      is2026: true,
      projectCount: 1,
    },
    projects: [
      {
        title: 'Radis Exoplanet Infrared Radiative Transfer Spectral Solver',
        description: 'Implement GPU-accelerated non-equilibrium line-by-line spectral synthesis for high-temperature exoplanetary atmospheres.',
        difficulty: 'Advanced',
        techStack: ['python', 'numba', 'cuda', 'physics'],
        githubUrl: 'https://github.com/radis/radis',
        stars: 620,
        mentors: ['Erwan Pannier', 'Minou Droussiot'],
        topics: ['spectroscopy', 'physics', 'exoplanets'],
        year: 2026,
      }
    ]
  },
  {
    org: {
      name: 'CEA (French Atomic & Alternative Energy Commission)',
      slug: 'cea-space',
      description: 'CEA is a French major research organization in energy, defense, and space astrophysics, maintaining the open Salomé scientific simulation platform.',
      websiteUrl: 'https://www.cea.fr/english',
      logoUrl: 'https://cdn.simpleicons.org/cplusplus',
      category: 'Scientific Computing & Multiphysics',
      technologies: ['c++', 'python', 'qt', 'opengl', 'vtk'],
      topics: ['multiphysics', 'cad', 'finite-element', 'scientific-computing'],
      years: [2021, 2022, 2023, 2024, 2025, 2026],
      is2026: true,
      projectCount: 1,
    },
    projects: [
      {
        title: 'Salomé Multiphysics Mesh CAD Thermal Expansion Modeler',
        description: 'Implement 3D tetrahedral adaptive remeshing routines for spacecraft heat-shield reentry thermal simulations.',
        difficulty: 'Advanced',
        techStack: ['c++', 'python', 'vtk', 'salome'],
        githubUrl: 'https://github.com/salome-platform/salome',
        stars: 480,
        mentors: ['Christophe Bourcier', 'Guillaume Boulant'],
        topics: ['cad', 'finite-element', 'spacecraft', 'physics'],
        year: 2026,
      }
    ]
  },
  {
    org: {
      name: 'ONERA (French Aerospace Lab)',
      slug: 'onera-flight',
      description: 'ONERA is the French national aerospace research laboratory conducting cutting-edge aeronautical fluid dynamics and spacecraft aerodynamics research.',
      websiteUrl: 'https://www.onera.fr/en',
      logoUrl: 'https://cdn.simpleicons.org/fortran',
      category: 'Aerodynamics & Fluid Dynamics',
      technologies: ['c++', 'python', 'fortran', 'mpi', 'openmp'],
      topics: ['aerodynamics', 'cfd', 'space-propulsion', 'flight-physics'],
      years: [2021, 2022, 2023, 2024, 2025, 2026],
      is2026: true,
      projectCount: 1,
    },
    projects: [
      {
        title: 'OpenCFD High-Mach Rocket Exhaust Plume Expansion Simulator',
        description: 'Parallelize Navier-Stokes hypersonic shockwave solver kernels using OpenMP 5.0 target offloading on European supercomputer clusters.',
        difficulty: 'Advanced',
        techStack: ['c++', 'mpi', 'openmp', 'cfd'],
        githubUrl: 'https://github.com/onera/opencfd',
        stars: 320,
        mentors: ['Dr. Marc Gazengel', 'Sylvain Lemaire'],
        topics: ['cfd', 'aerospace', 'supercomputing'],
        year: 2026,
      }
    ]
  },
  {
    org: {
      name: 'Royal Observatory of Belgium (STCE / ROB)',
      slug: 'rob-stce',
      description: 'The Solar-Terrestrial Centre of Excellence (STCE) at the Royal Observatory of Belgium provides European space weather forecasting and solar activity monitoring.',
      websiteUrl: 'https://www.stce.be',
      logoUrl: 'https://cdn.simpleicons.org/astropy',
      category: 'Solar Physics & Space Weather',
      technologies: ['python', 'scipy', 'numpy', 'opencv', 'fastapi'],
      topics: ['solar-physics', 'space-weather', 'sunspots', 'coronal-mass-ejections'],
      years: [2020, 2021, 2022, 2023, 2024, 2025, 2026],
      is2026: true,
      projectCount: 1,
    },
    projects: [
      {
        title: 'Sunspot Automated Computer Vision Tracking & CME Warning Engine',
        description: 'Train convolutional neural networks to detect solar flare magnetic field twist precursors on real-time SDO / PROBA-2 satellite coronagraph feeds.',
        difficulty: 'Intermediate',
        techStack: ['python', 'pytorch', 'opencv', 'fastapi'],
        githubUrl: 'https://github.com/stce/spaceweather-cme-tracker',
        stars: 410,
        mentors: ['Dr. Petra Vanlommel', 'Ronald Van der Linden'],
        topics: ['space-weather', 'computer-vision', 'solar-physics'],
        year: 2026,
      }
    ]
  },
  {
    org: {
      ...
      slug: 'sron-space',
      description: 'SRON develops cutting-edge space instruments for astrophysics and Earth observation missions including SPEXone on NASA PACE and XMM-Newton.',
      websiteUrl: 'https://www.sron.nl',
      logoUrl: 'https://cdn.simpleicons.org/python',
      category: 'Space Instrumentation & Spectropolarimetry',
      technologies: ['python', 'c++', 'scipy', 'matplotlib', 'hdf5'],
      topics: ['spectropolarimetry', 'satellites', 'aerosols', 'instrumentation'],
      years: [2021, 2022, 2023, 2024, 2025, 2026],
      is2026: true,
      projectCount: 1,
    },
    projects: [
      {
        title: 'SPEXone Aerosol Microphysics Inversion Retrieval Algorithm',
        description: 'Implement Phillips-Tikhonov regularized gradient inversion for retrieving atmospheric aerosol refractive index from multi-angle polarized light.',
        difficulty: 'Advanced',
        techStack: ['python', 'scipy', 'numpy', 'hdf5'],
        githubUrl: 'https://github.com/sron/spexone-inversion',
        stars: 270,
        mentors: ['Otto Hasekamp', 'Jeroen Rietjens'],
        topics: ['atmosphere', 'optics', 'space-missions'],
        year: 2026,
      }
    ]
  },
  {
    org: {
      name: 'European Synchrotron Radiation Facility (ESRF)',
      slug: 'esrf-synchrotron',
      description: 'ESRF operates the most intense synchrotron radiation source in Europe, open-sourcing Silx and PyMca for real-time 3D X-ray micro-tomography.',
      websiteUrl: 'https://www.esrf.fr',
      logoUrl: 'https://cdn.simpleicons.org/opengl',
      category: 'Scientific Visualization & X-Ray Tomography',
      technologies: ['python', 'c++', 'qt', 'opengl', 'opencl'],
      topics: ['xray', 'tomography', 'scientific-visualization', 'materials-science'],
      years: [2020, 2021, 2022, 2023, 2024, 2025, 2026],
      is2026: true,
      projectCount: 1,
    },
    projects: [
      {
        title: 'Silx 3D Volume Rendering & Tomographic Filter GPU Acceleration',
        description: 'Build fast PyOpenCL filtered back-projection (FBP) reconstruction filters for high-speed material science beamline measurements.',
        difficulty: 'Advanced',
        techStack: ['python', 'c++', 'opencl', 'qt'],
        githubUrl: 'https://github.com/silx-kit/silx',
        stars: 620,
        mentors: ['Armando Solé', 'Henri Payno'],
        topics: ['tomography', 'scientific-visualization', 'gpu'],
        year: 2026,
      }
    ]
  },
  {
    org: {
      name: 'IRAP (Astrophysics & Planetology Research Inst - Toulouse)',
      slug: 'irap-astro',
      description: 'IRAP is the French laboratory for planetology and astrophysics in Toulouse, creating the AMDA Automated Multi-Dataset Analysis space plasma tool.',
      websiteUrl: 'https://www.irap.omp.eu/en',
      logoUrl: 'https://cdn.simpleicons.org/astropy',
      category: 'Planetary Science & Space Plasma',
      technologies: ['python', 'javascript', 'c++', 'webgl', 'hdf5'],
      topics: ['planetary-science', 'space-plasma', 'bepicolombo', 'solar-wind'],
      years: [2021, 2022, 2023, 2024, 2025, 2026],
      is2026: true,
      projectCount: 1,
    },
    projects: [
      {
        title: 'AMDA Space Plasma Magnetic Field Topology Interactive Visualizer',
        description: 'Construct interactive 3D particle trajectory flow field streamline renderers for BepiColombo Mercury orbit data feeds.',
        difficulty: 'Intermediate',
        techStack: ['javascript', 'three.js', 'python', 'webgl'],
        githubUrl: 'https://github.com/irap-plasma/amda-vis',
        stars: 340,
        mentors: ['Dr. Vincent Génot', 'Christian Jacquey'],
        topics: ['space-plasma', 'webgl', 'planetary-science'],
        year: 2026,
      }
    ]
  },
  {
    org: {
      name: 'Airbus Defence and Space Open Lab',
      slug: 'airbus-space',
      description: 'Airbus Defence and Space open-sources satellite constellation power simulators and space telemetry data models for European aerospace engineers.',
      websiteUrl: 'https://www.airbus.com/en/products-services/space',
      logoUrl: 'https://cdn.simpleicons.org/airbus',
      category: 'Satellite Engineering & Telemetry',
      technologies: ['c++', 'python', 'rust', 'linux'],
      topics: ['satellites', 'telemetry', 'power-simulation', 'aerospace'],
      years: [2022, 2023, 2024, 2025, 2026],
      is2026: true,
      projectCount: 1,
    },
    projects: [
      {
        title: 'Satellite EPS Solar Array Peak Power Tracker & Battery Life Estimator',
        description: 'Simulate electrochemical Li-ion battery degradation cycles over 15-year orbital lifetimes under cyclic orbital eclipses.',
        difficulty: 'Advanced',
        techStack: ['python', 'c++', 'scipy'],
        githubUrl: 'https://github.com/airbus/satellite-eps-sim',
        stars: 490,
        mentors: ['Pierre-Yves Chevalier', 'Antoine Lefebvre'],
        topics: ['satellites', 'battery', 'power-systems'],
        year: 2026,
      }
    ]
  }
...
async function seedEsoc25Orgs() {
  ...
  try {
    ...
    // Clean up old sample dummy orgs if they had dummy slugs
    await orgsCol.deleteMany({ programSlug: 'esoc', slug: 'vertex-ai' });

    let seededOrgs = 0;
    let seededProjects = 0;

    for (const item of ALL_25_ESOC_ORGS_AND_PROJECTS) {
      const orgData = {
        ...item.org,
        programId: programId,
        programSlug: 'esoc',
    ...
    console.log(`\n Successfully seeded ${seededOrgs} Comprehensive ESoC Organizations and ${seededProjects} ESoC Projects!`);
  } catch (err) {
