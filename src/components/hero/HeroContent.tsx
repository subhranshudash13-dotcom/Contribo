...
export function HeroContent() {
    return (
        <div className="relative z-10 w-full flex flex-col items-center text-center lg:items-start lg:text-left pt-4 sm:pt-8 lg:-ml-[3px]">
            <h1 className="text-[37px] sm:text-[49px] lg:text-[61px] xl:text-[69px] font-bold tracking-tight text-primary leading-[1.12] mb-4 font-heading">
                Accelerate Your<br className="hidden sm:inline" />{' '}
                <span className="bg-clip-text text-transparent bg-gradient-to-r from-accent via-accent to-brass whitespace-nowrap">
                    Open Source
                </span>{' '}
                Career.
            </h1>
            
            <p className="text-base sm:text-lg lg:text-xl text-secondary leading-relaxed max-w-[560px] mb-8 mx-auto lg:mx-0 font-normal">
